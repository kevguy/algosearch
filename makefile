...
# 	go run app/cal-engine/main.go --auth-keys-folder=./keys-dir
	go run backend/app/algosearch/main.go \
		--web-enable-sync=false \
		--couch-db-protocol=http \
		--couch-db-user=kevin \
		--couch-db-password=makechesterproud! \
		--couch-db-host=89.39.110.254:5984 \
		--couch-db-name=algo_global \
		--algorand-algod-protocol=http \
		--algorand-algod-addr=89.39.110.254:4001 \
		--algorand-algod-token=a2d2ac864300588718c6c05ff241a14fad99d30a19806356f3b9c8008559c4c1 \
