...
then
  ...
  curl -X PUT "${ALGOSEARCH_COUCH_DB_PROTOCOL}://${ALGOSEARCH_COUCH_DB_USER}:${ALGOSEARCH_COUCH_DB_PASSWORD}@${ALGOSEARCH_COUCH_DB_HOST}/${ALGOSEARCH_COUCH_DB_NAME}?partitioned=false"
